"""
This file contains the code to train and save a model to do binary prediction on the same dataset
The end goal is to compare this to the current model used.
"""
...
for i in range(HIST_LEN, len(train_scaled) - HORIZON):
    ...
    if total_future_rain == 0 and np.random.rand() > UNDERSAMPLING_RATE:
        continue
...
model.save("../model_testing/classifier_nokan.keras")
